# Unified FinGuard AI Dockerfile (Single-Service)
...
# Install ONLY production dependencies for the Gateway
WORKDIR /app/api-gateway
...
# Railway usually listens on PORT, so we expose the default
EXPOSE 4000
